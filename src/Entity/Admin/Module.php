...
/**
 * @ORM\Entity(repositoryClass="Percas\Repository\Admin\ModuleRepository")
 * @ORM\Table(name="adm_modules")
 */
class Module
{
    /**
     ...
     * @var Application[]
     *
     * @ORM\OneToMany(targetEntity="Percas\Entity\Admin\Application", mappedBy="module")
     */
